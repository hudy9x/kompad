...
export default function Category() {
  const {
    query: { recently, important, tag, folder },
    filterByRecently,
    clearFilter,
    filterByImportant,
  } = usePadListStore()
  ...
  return (
    <section className="sec-container">
      ...
      <div className="sec-content">
        <div
          className={`sec-item ${isAllActive ? 'font-bold' : ''}`}
          onClick={showAll}
        >
          <HiOutlineCube />
          All pad
        ...
        <div
          className={`sec-item ${recently ? 'font-bold' : ''}`}
          onClick={onRecently}
        >
          <HiOutlineClock />
          Recently
        ...
        <div
          className={`sec-item ${important ? 'font-bold' : ''}`}
