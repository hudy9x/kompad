...
export const Outline = () => {
  ...
  console.log(contentOutline, "contentOutline");
      ...
      case 2:
        return (
          <div className="flex outline-content" onClick={() => handleOutLineDropdown(value.id, value.level)}>
            ...
            <a className='pl-1' href={`#${value.id}`} >{value.title}</a>
          </div>
        )
      case 3:
        return (
          <div className="flex outline-content" onClick={() => handleOutLineDropdown(value.id, value.level)}>
            ...
            {value.isCheck && <a className='outline-content pl-8' href={`#${value.id}`} >{value.title}</a>}
          </div>
        )
      case 4:
        return (
