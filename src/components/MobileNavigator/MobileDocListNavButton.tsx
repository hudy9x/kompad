...
export default function MobileDocListNavButton() {
  ...
  return <div 
    className="absolute top-4 left-8 w-9 h-9 sm:hidden rounded-md flex items-center justify-center bg-white/60 z-10 hover:bg-white/90 cursor-pointer shadow-lg active:bg-white/80"  
